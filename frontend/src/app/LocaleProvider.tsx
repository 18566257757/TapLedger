...
const en = {
  ...
  byCategory: 'By category', whereMoneyWent: 'Where your money went.', topMerchants: 'Top merchants', highestDestinations: 'Your highest spend destinations.', paymentMethods: 'Payment methods', allocation: 'Spend allocation across cards and wallets.', unmapped: 'Not assigned',
...
const zhCN: Translation = {
  ...
  netSpending: '净支出', thisMonth: '本月', needsReview: '待你复核', openReview: '打开复核队列',
  ...
  byCategory: '按类别', whereMoneyWent: '了解钱花在何处。', topMerchants: '主要商户', highestDestinations: '支出最高的商户。', paymentMethods: '支付方式', allocation: '不同卡片和钱包的支出分布。', unmapped: '未指定',
  ...
  selectCategory: '选择类别', paymentMethod: '支付方式', selectMethod: '选择支付方式', dateTime: '日期和时间', purpose: '用途', note: '备注',
...
const zhTW: Translation = {
  ...
  goodMorning: '早安', goodAfternoon: '午安', goodEvening: '晚安', ledgerReady: '你的私人帳本已就緒。', needsReview: '待你複核', openReview: '開啟複核佇列',
  ...
  byCategory: '按類別', whereMoneyWent: '了解錢花在何處。', topMerchants: '主要商戶', highestDestinations: '支出最高的商戶。', paymentMethods: '付款方式', allocation: '不同卡片和錢包的支出分布。', unmapped: '未指定',
  ...
  language: '語言', followBrowser: '跟隨瀏覽器', english: '英文', simplifiedChinese: '簡體中文', traditionalChinese: '繁體中文', type: '類型', merchant: '商戶', category: '類別', selectCategory: '選擇類別', paymentMethod: '付款方式', selectMethod: '選擇付款方式', dateTime: '日期和時間', note: '備註', location: '地點', latitude: '緯度', longitude: '經度', excludeAnalytics: '不計入統計', source: '來源', optional: '選填',
  ...
  uncategorizedTransactions: '未分類交易', missingDetails: '資訊缺失', potentialDuplicates: '疑似重複', lessThanLastMonth: '低於上月', moreThanLastMonth: '高於上月', noPreviousPeriod: '暫無上月比較', monthlyChart: '本月淨支出趨勢圖', trendEmpty: '產生交易後將在這裡顯示趨勢。', spendingTrend: '30 天支出趨勢', viewAllTransactions: '查看全部交易', review: '複核', moreInformation: '更多資訊', hideInformation: '收起更多資訊', firstUseHint: '首次使用：請先建立私人管理員，然後再登入。', showPassword: '顯示密碼', hidePassword: '隱藏密碼', passwordHint: '至少使用 12 個字元，僅儲存加鹽密碼雜湊。',

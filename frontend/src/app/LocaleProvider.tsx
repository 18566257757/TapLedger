...
const en = {
  ...
  byCategory: 'By category', whereMoneyWent: 'Where your money went.', whereMoneyCameFrom: 'Where your money came from.', whereTotalMoved: 'Combined income and spending by category.', topMerchants: 'Top merchants', highestDestinations: 'Your highest spend destinations.', paymentMethods: 'Payment methods', allocation: 'Spend allocation across cards and wallets.', unmapped: 'Not assigned',
...
const zhCN: Translation = {
  ...
  byCategory: '按类别', whereMoneyWent: '了解钱花在何处。', whereMoneyCameFrom: '了解收入来自何处。', whereTotalMoved: '按类别查看收入与支出的合计。', topMerchants: '主要商户', highestDestinations: '支出最高的商户。', paymentMethods: '支付方式', allocation: '不同卡片和钱包的支出分布。', unmapped: '未指定',
...
const zhTW: Translation = {
  ...
  byCategory: '按類別', whereMoneyWent: '了解錢花在何處。', whereMoneyCameFrom: '了解收入來自何處。', whereTotalMoved: '按類別查看收入與支出的合計。', topMerchants: '主要商戶', highestDestinations: '支出最高的商戶。', paymentMethods: '付款方式', allocation: '不同卡片和錢包的支出分布。', unmapped: '未指定',

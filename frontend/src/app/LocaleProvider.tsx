...
const zhCN: Translation = {
  ...
  configuration: '配置', settingsSubtitle: '管理采集、分类、隐私和私有数据。', signOut: '退出登录', automation: '自动化', categories: '类别', merchantRules: '商户规则', dataBackups: '数据与备份', serverStatus: 'Cloudflare 部署', preferences: '偏好设置',
...
const zhTW: Translation = {
  ...
  configuration: '設定', settingsSubtitle: '管理擷取、分類、隱私和私有資料。', signOut: '登出', automation: '自動化', categories: '類別', merchantRules: '商戶規則', dataBackups: '資料與備份', serverStatus: 'Cloudflare 部署', preferences: '偏好設定',

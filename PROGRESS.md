...
- 开源准备：公共/实例配置隔离、部署脚本、publication check、GitHub-hosted CI 和 Dependabot。
...
- GitHub 公共仓库 `18566257757/TapLedger` 已创建，README Deploy 按钮已指向该仓库；本地迁移提交和分支推送待完成。
- iPhone 上的 PWA、Shortcut 与 Wallet Personal Automation 真机操作。

未实际完成的 GitHub 分支推送和 iPhone 真机步骤不会标记为成功。
